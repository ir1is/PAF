...
mercury = universe.Planet("Merkur",'green', 3.3 * 10**24, np.array((0., 0.466*au)), np.array((-47362., 0.)))
venus = universe.Planet("Venus",'red', 4.8685*10**24, np.array((0.723*au, 0.)), np.array((0., 35020.)))
earth = universe.Planet("Earth",'blue', 5.9742 * 10**24, np.array((float(-1. * au), 0.)), np.array((0., float(-29783))))
mars = universe.Planet("Mars",'gray', 6.417*10**23, np.array((0., -1.666*au)), np.array((24007., 0.)))


svemir = universe.Universe(5*365.242*3600*24,60*60*24)
...
metadata = dict(title="universe", artist = "ja")
